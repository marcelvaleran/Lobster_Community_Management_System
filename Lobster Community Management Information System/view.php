...
<head>
    ...
    <title>Lobster Information</title>
</head>
            ...
            <div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Menu</span> </a>
                <div class="nav_list"> 
                    ...
                    <a href="customer_lists.php" class="nav_link"> 
                        <i class='fas fa-users fa-sm nav_icon' style="margin-left: 1px;" title="Customer"> </i> 
...
<div class="d-flex justify-content-center">
    ...
    <div style="border: 1px solid #fff; border-radius: 8px;">
         <div class="card" style="border-radius: 8px; background: rgba(45, 98, 245, 0.2);">
            ...
            <h2 class="card-title"><i class="fas fa-th-list"></i><b> Lobster Information</b></h2>
            ...
            <div style="overflow: hidden; margin-bottom: -1.7em; width: 65%; float: right; position: relative; z-index: 1;">
                ...
                <a class="btn btn-primary mr-1" title="New Data" href="member_add.php"><i class="fa fa-plus fa-lg"></i></a>
            </div>
                        ...
                        while($row=mysqli_fetch_assoc($res))
                        {
                            ...
                            ?>
                                <tr align='center' style="background: transparent;">
                                    ...
                                    <td><?php echo $date; ?></td>
                                    <td>
                                     <a class="badge badge-success" style="padding: 7px" href="update.php?info_id=<?php echo $info_id; ?>"><i class="fas fa-pen" title="Update"></i> </a>
                                     <a class="badge badge-danger" style="padding: 7px" href="delete.php?info_id=<?php echo $info_id; ?>" onclick="return confirm('Delete this data ?')"><i class="fas fa-trash-alt" title="Delete"></i> </a>
                                    </td>
                                </tr>
                            <?php
                            $sno++;
