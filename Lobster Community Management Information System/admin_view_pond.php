        ...
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Menu</span> </a>
                <div class="nav_list"> 
                    ...
                    <a href="admin_view_pond.php" class="nav_link active"> 
                        ...
                        while($row=mysqli_fetch_assoc($res))
                        {
                            ...
                            ?>
                                <tr align='center' style="background: transparent;">
                                    ...
                                    <td>
                                      <a class="badge badge-success" style="padding: 7px" href="update_pond.php?pond_id=<?php echo $pond_id; ?>"><i class="fas fa-pen" title="Update"></i> </a>
                                      <a class="badge badge-danger" style="padding: 7px" href="delete_pond.php?pond_id=<?php echo $pond_id; ?>" onclick="return confirm('Delete this data ?')"><i class="fas fa-trash-alt" title="Delete"></i> </a>
                                    </td>
                                </tr>
                            <?php
                            $sno++;
