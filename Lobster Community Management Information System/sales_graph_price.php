...
{
    $dateReset = $row2['reset_date_price'];
}
    ...
    <div style="text-align:center; width: 80%; margin: auto;">
        <form method="POST">
            <h2 class="page-header">Price Chart 
                ...
                <a href="#" data-toggle="modal" data-target="#reset" class="btn btn-primary" style="margin-right: 11em;">
                    ...
                    <form action="" method="POST" class="row register-form" >
                        ...
                        <div class="form-group">
                            <label for="lastname" style="color: #fff; font-size: 18px;"><i class="fas fa-info-circle mr-2"></i>
                                All price data will be reset to 0 (zero) in this chart
...
<?php 
    ...
    if(isset($_POST['submit']))
    {
        ...
        sales_size.price = '$price',
        range_date.reset_date_price = '$resetDatee'
        WHERE id = 5
        ";
        ...
        if($res3==true)
        {
            ...
            echo "<script>window.location = 'sales_graph_price.php'</script>";
        }
        else
        {
