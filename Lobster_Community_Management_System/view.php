                        ...
                        while($row=mysqli_fetch_assoc($res))
                        {
                            ...
                            ?>
                                <tr align='center' style="background: transparent;">
                                    ...
                                    <td><?php echo $date; ?></td>
                                    <td>
                                        <a class="badge badge-success" style="padding: 6px" href="update.php?info_id=<?php echo $info_id; ?>">Update </a>
                                        <a class="badge badge-danger" style="padding: 6px" href="delete.php?info_id=<?php echo $info_id; ?>">Delete</a>
                                    </td>
                                </tr>
                            <?php
                            $sno++;
