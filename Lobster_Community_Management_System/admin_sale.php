...
<div class="d-flex justify-content-center">
    ...
    <div style="border: 1px solid #fff; border-radius: 8px;">
         <div class="card" style="border-radius: 8px; background: rgba(45, 98, 245, 0.2);">
            ...
            <h2 class="card-title"><i class="fas fa-th-list"></i> <b>List of Product</b></h2>
                        ...
                        while($row=mysqli_fetch_assoc($res))
                        {
                            ...
                            ?>
                                <tr align='center' style="background: transparent;">
                                    ...
                                    <td>
                                        <a class="badge badge-success" style="padding: 6px" href="admin_transac.php?info_id=<?php echo $info_id; ?>">Add Transaction </a>
                                    </td>
                                </tr>
