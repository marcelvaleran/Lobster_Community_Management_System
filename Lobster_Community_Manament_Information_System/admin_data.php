        ...
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Menu</span> </a>
                <div class="nav_list"> 
                    ...
                    <a href="admin_data.php" class="nav_link active"> 
...
<div class="d-flex justify-content-center">
    ...
    <div style="border: 1px solid #fff; border-radius: 8px;">
         <div class="card" style="border-radius: 8px; background: rgba(45, 98, 245, 0.2);">
            ...
            <h2 class="card-title"><i class="fas fa-th-list"></i><b> List of Information</b></h2>
                        ...
                        while($row=mysqli_fetch_assoc($res))
                        {
                            ...
                            ?>
                                <tr align='center' style="background: transparent;">
                                    ...
                                    <td><?php echo $date;?></td>
                                    <td>
                                      <a class="badge badge-success" style="padding: 7px" href="admin_update.php?info_id=<?php echo $info_id; ?>"><i class="fas fa-pen" title="Update"></i> </a>
                                      <a class="badge badge-danger" style="padding: 7px" href="admin_delete.php?info_id=<?php echo $info_id; ?>" onclick="return confirm('Delete this data ?')"><i class="fas fa-trash-alt" title="Delete"></i> </a>
                                    </td>
                                </tr>
                            <?php
                            $sno++;
