        ...
        <div class="col-md-12 register-right">
            <div class="tab-content" id="myTabContent">
                    <form class="row register-form" >
                        ...
                        <div class="form-group">
                            <label for="lastname"><i class="fas fa-users"></i> Customer</label>
                            <input type="text" class="form-control" name="buyer" value="<?php echo $buyer; ?>" readonly/>
                        </div>
                        <div class="form-group">
                            <label for="lastname"><i class="fas fa-phone"></i> Customer Contact</label>
                        ...
                        <div class="col-md">
                            <div class="form-group" style="width: 100%;">
                                <label for="lastname"><i class="fas fa-map-marked-alt"></i> Customer Address</label>
