...
<div class="d-flex justify-content-center">
    <div class="col-lg-8 grid-margin stretch-card">
        ...
        <div class="card" style="border-radius: 8px; background: rgba(45, 98, 245, 0.2);">
            ...
            <h3 class="card-title" style="color: red;"><i class="fa fa-sitemap"></i> <b>Size Category</b></h3>
...
<div class="d-flex justify-content-center">
    <div class="col-lg-8 grid-margin stretch-card">
        ...
        <div class="card" style="border-radius: 8px; background: rgba(45, 98, 245, 0.2);">
            <div class="card-body" style="background: rgba(45, 98, 245, 0.8);">
            <h2 class="card-title"><i class="fa fa-th-list"></i> <b>Detail Information</b></h2>
...
$query=mysqli_query($conn, "SELECT * FROM information WHERE `description`='$category' ORDER BY info_id ASC") or die(mysqli_error($conn));
                            $qty = 0;
                            ...
                            $query=mysqli_query($conn, "SELECT * FROM information ORDER BY info_id ASC") or die(mysqli_error());
                            $qty = 0;
                            while($row=mysqli_fetch_array($query)){
                                $qty += $row['difficulty'];
                                $info_id = $row['info_id'];?>
