...
<div class="d-flex justify-content-center">
    ...
    <tr align='center'>
    <th>
        <a class="btn btncategory button3" href="admin_size_detail.php" style="width: 100%; background: #c32525;">
            <i class="fas fa-utensils fa-lg mt-1" style="float: left;"></i> Consumption
        </a>
    </th>
    <th>
        <a class="btn btncategory button3" href="admin_size_detail2.php" style="width: 100%;">
...
$query=mysqli_query($conn, "SELECT * FROM information WHERE `size`='$category' AND `allotment`='Consumption' ORDER BY info_id ASC") or die(mysqli_error($conn));
                            $qty = 0;
                            ...
                            $query=mysqli_query($conn, "SELECT * FROM information WHERE `allotment`='Consumption' ORDER BY info_id ASC") or die(mysqli_error());
                            $qty = 0;
                            while($row=mysqli_fetch_array($query)){
                                $qty += $row['quantity'];
                                $info_id = $row['info_id'];?>
