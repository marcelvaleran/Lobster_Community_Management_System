                        ...
                        while($row=mysqli_fetch_assoc($res))
                        {
                            ...
                            ?>
                                <tr align='center' style="background: transparent;">
                                    ...
                                    <td>
    <a class="badge badge-success" style="padding: 7px" href="transac.php?info_id=<?php echo $info_id; ?>&amp;size_id=<?php echo $size_id; ?>" title="Add Transaction Data">Add Transaction </a>
                                    </td>
                                </tr>
