                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3 my-3">
                        <div class="form-control">
                            ...
                            <p class="spaces" style="font-size: 36px;"><?php echo $tusers; ?><i class="fas fa-user-circle right"></i></p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3 my-3">
                        <div class="form-control">
                    ...
                    <div class="col-md-6 col-lg-3 my-3">
                        <div class="form-control">
                            <h5 class="spaces">Customer Data </h5>
                            <p class="spaces" style="font-size: 36px;"><?php echo $tcust; ?><i class="fas fa-users right"></i></p>
                        </div>
                    </div>
                </div>
            </form>
                                ...
                                <div class="job-left my-4 d-md-flex align-items-center flex-wrap">
                                    ...
                                    <div class="job-content">
                                        ...
                                        <ul class="d-md-flex flex-wrap text-capitalize ff-open-sans">
                                            <li class="mr-md-4">
                                                <i class="fas fa-marker mr-2"></i> Allotment: <?php echo $allotment; ?>
                                            </li>
                                            <li class="mr-md-4">
                                                <i class="fas fa-sort-numeric-up mr-2"></i> Size: <?php echo $size; ?> Inch
                                            </li>
                                            <li class="mr-md-4">
                                                <i class="fas fa-boxes mr-2"></i> Quantity: <?php echo $quantity; ?>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
