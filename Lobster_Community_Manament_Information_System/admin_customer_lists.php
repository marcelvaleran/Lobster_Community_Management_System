    ...
    <div style="border: 1px solid #fff; border-radius: 8px;">
         <div class="card" style="border-radius: 8px; background: rgba(45, 98, 245, 0.2);">
            ...
            <div style="overflow: hidden; margin-bottom: -1.7em; width: 70%; float: right; position: relative; z-index: 1;">
                ...
                <a class="btn btn-primary mr-1" title="Request List" href="admin_customer_req.php"><i class="fa fa-tasks fa-lg"></i></a>
 ...
 if($res==true)
    {
        ...
        if($count_rows>0)
        {
            ...
            while($row=mysqli_fetch_assoc($res))
            {
                ...
                $create_date = $row['create_date'];
                ?>
<div class="modal fade" id="views<?php echo $row['cust_id']; ?>" tabindex="" role="dialog" aria-hidden="true">
            ...
            <div class="tab-content" id="myTabContent">
                    <form action="" method="POST" class="row register-form" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="id_card" list="suggest" class="form-control bold" required />
                        </div>
                        <div class="form-group">
...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($duplicate)>0) {
        echo "<script>alert('This customer data already exist or on request!')</script>";
    } else{
    ...
    if ($result) { 
        echo "<script>window.location = 'admin_customer_lists.php';</script>";
        ...
        <div class="col-md-12 register-right">
            <div class="tab-content" id="myTabContent">
                    <form action="" method="POST" class="row register-form" >
                        ...
                        <div class="form-group">
                            <label for="lastname"><i class="fas fa-id-card-alt mr-2"></i> ID Card<span class="text-danger"> *</span></label>
                            <input type="text" class="form-control bold" name="id_card2" value="<?php echo $id_card; ?>" required/>
                        </div>
                        <div class="form-group">
                            <label for="lastname"><i class="fas fa-users mr-2"></i> Customer<span class="text-danger"> *</span></label>
...
<?php 
    if(isset($_POST['submitedit']))
    {
        ...
        $duplicate = mysqli_query($conn,"SELECT * FROM customer WHERE id_card = '0'");
