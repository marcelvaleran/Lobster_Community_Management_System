...
<div class="d-flex justify-content-center">
    ...
    <div style="border: 1px solid #fff; border-radius: 8px;">
        ...
        <?php
            ...
            $sql = "SELECT * FROM customer WHERE user_id6 = $user_id AND request = 'Pending' OR user_id6 = $user_id AND request = 'Rejected' ";
                    ...
                    if($count_rows>0)
                    {
                        ...
                        while($row=mysqli_fetch_assoc($res))
                        {
                            ...
                            <tr align='center' style="background: transparent;">
                                ...
                                <td><b style="color: orange;"><?php echo $request; ?></b></td>
                                <td>
            ...
            <a class="badge badge-danger" style="padding: 7px" href="delete_cust.php?cust_id=<?php echo $cust_id; ?>" onclick="return confirm('Delete this request ?')"><i class="fas fa-trash-alt" title="Delete"></i> </a>
                                </td>
                            </tr>
                            <?php
                            $sno++;
...
if (isset($_POST['submit'])) {
    ...
    $sql2 = "INSERT INTO customer (user_id6, cust_name, phoneNo, email, address, post_code, subdistrict, create_date, request)
            VALUES ('$user_id', '$buyer_name', '$phoneNo', '$email', '$address', '$post_code', '$subdistrict', '$create_date', '$request')";
...
<div class="modal fade" id="editData<?php echo $row['cust_id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgba(9, 95, 219, 1); ">
        <h3 class="modal-title"><i class="fas fa-user-edit" title="View"></i> Customer Information Request</h3>
            <button type="button" class="close btn mr-1" data-dismiss="modal" aria-label="Close">
              <i class="fas fa-times fa-lg"></i>
            </button>
      </div>
